...
morea_labels:
 - by 3/6
---
# Practice WOD7: Go with the (control) flow

Rather than writing a program, in this practice WOD you will walk through the execution of a program on paper. ***You don’t need to run either program to complete the assignment.***
